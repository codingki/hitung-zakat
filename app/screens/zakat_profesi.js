...
gaji = (a) => {
  ...
  hitungZakat = () => {
    const gaji = parseInt(this.state.gaji)*12
    const cicilan = parseInt(this.state.cicilan)*12
    const hasil = gaji - cicilan
    const kali = hasil*2.5/100
    this.setState({
      zakat:kali
    })
  }
    ...
    >
        ...
        <View style={{flex:1, flexDirection:'column', backgroundColor:'white', marginTop:20, marginLeft:20, marginRight:20, padding:10, justifyContent: 'flex-start', paddingBottom:20}}>
          ...
          <View>
            ...
            <Text style={{ color: '#faaf3b', fontSize:20, marginLeft: 10, marginBottom:10}}>Gaji</Text>
          </View>

          <View>
          <Item regular style={{marginRight:10, marginLeft: 10}}>
            <Input  placeholder='Gaji perbulan' keyboardType='numeric'  onChangeText={(text) => this.gaji(text)} />
          </Item>
        ...
        <View style={{flex:1, flexDirection:'column', backgroundColor:'white', marginTop:20, marginLeft:20, marginRight:20, padding:10, justifyContent: 'flex-start', paddingBottom:20}}>
          ...
          <View>
            ...
            <Text style={{ color: '#faaf3b', fontSize:20, marginLeft: 10, marginBottom:10}}>Hutang</Text>
          </View>

          <View>
          <Item regular style={{marginRight:10, marginLeft: 10}}>
            <Input keyboardType='numeric'  onChangeText={(text) => this.hutang(text)} value={this.state.hutang} />
          </Item>
        ...
        <View style={{flex:1, flexDirection:'column', backgroundColor:'white', marginTop:20, marginLeft:20, marginRight:20, padding:10, justifyContent: 'flex-start', paddingBottom:20}}>
          ...
          <View>
            ...
            <Text style={{ color: '#faaf3b', fontSize:20, marginLeft: 10, marginBottom:10}}>Harga Emas</Text>
          </View>
